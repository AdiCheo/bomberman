...
public class PlayerBombs extends BaseTest{
    ...
    public void test() throws InterruptedException
    {
        ...
        assertEquals("Check the wall is still standing", Tile.WALL, logic.getTile(wall));
        assertEquals("Check the wall is still standing", Tile.EMPTY, logic.getTile(destructable));
        
        //Check the exit as been revealed
        assertEquals("Checks if the exit as been revealed", false, logic.isExitHidden());
    }
